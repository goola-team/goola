...
# 1. install goola for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for goola
# 5. create goola, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable Goola_SOCKET
...
!define GROUPNAME "Goola"
!define APPNAME "goola"
!define DESCRIPTION "Official Go implementation of the Goola protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since goola is installed global
