Name "goola.${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/goola-team/goola/issues"
!define UPDATEURL "https://github.com/goola-team/goola/releases"
!define ABOUTURL "https://github.com/goola-team/goola"
...
# Install goola binary
Section "goola" GOOLA_IDX
  SetOutPath $INSTDIR
  file {{.goola}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\goola. exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\goola. exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "goola incoming peers (TCP:31318)"
  SimpleFC::AdvRemoveRule "goola outgoing peers (TCP:31318)"
  SimpleFC::AdvRemoveRule "goola UDP discovery (UDP:31318)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "goola incoming peers (TCP:31318)" ""  6 1 1 2147483647 1 "$INSTDIR\goola. exe" "" "" "Goola" 31318 "" "" ""
  SimpleFC::AdvAddRule "goola outgoing peers (TCP:31318)" ""  6 2 1 2147483647 1 "$INSTDIR\goola. exe" "" "" "Goola" "" 31318 "" ""
  SimpleFC::AdvAddRule "goola UDP discovery (UDP:31318)" "" 17 2 1 2147483647 1 "$INSTDIR\goola. exe" "" "" "Goola" "" 31318 "" ""

  ${EnvVarUpdate} $0 "Goola" "R" "HKLM" "\\.\pipe\goola. ipc"
  ${EnvVarUpdate} $0 "GOOLA_SOCKET" "A" "HKLM" "\\.\pipe\goola. ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GOOLA_IDX}
    SectionGetSize ${GOOLA_IDX} $0
