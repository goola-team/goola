...
import (
	...
	"github.com/goola-team/goola/crypto/sha3"
...
// ecrecover extracts the Goola account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Goola address
...
// Goola testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     gooladb.Database     // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // Goola address of the signing key
...
func New(config *params.CliqueConfig, db gooladb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Goola address recovered
