...
// Package chequebook package wraps the 'chequebook' Goola smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in goolabackend; (auto)cashing cheques in goolabackend
// as well as (auto)depositing goola to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/goola-team/goola/contracts/chequebook/contract"
	"github.com/goola-team/goola/core/types"
	"github.com/goola-team/goola/crypto"
	"github.com/goola-team/goola/log"
	"github.com/goola-team/goola/swarm/services/swap/swap"
)
...
// * depositing goola to the chequebook
// * watching incoming goolabackend
...
// Cash cashes the cheque by sending an Goola transaction.
