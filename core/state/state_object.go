...
// stateObject represents an Goola account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of Goola address of the account
	data     Account
	db       *StateDB
...
// Account is the Goola consensus representation of accounts.
