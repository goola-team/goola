...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	diskdb, _ := gooladb.NewMemDatabase()
...
// account array.
func checkStateAccounts(t *testing.T, db gooladb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db gooladb.Database, root common.Hash) error {
...
func checkStateConsistency(db gooladb.Database, root common.Hash) error {
...
func testIterativeStateSync(t *testing.T, batch int) {
	...
	dstDb, _ := gooladb.NewMemDatabase()
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(gooladb.Database), srcRoot)
