...
// Package types contains data types related to Goola consensus.
package types
...
// Header represents a block header in the Goola blockchain.
type Header struct {
...
// Block represents an entire block in the Goola blockchain.
type Block struct {
	header       *Header
	...
	// These fields are used by package goola to track
...
// [deprecated by goolabackend/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for goola protocol, etc.
...
// EncodeRLP serializes b into the Goola RLP block format.
