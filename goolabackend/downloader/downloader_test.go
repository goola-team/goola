...
type downloadTester struct {
	...
	stateDb gooladb.Database // Database used by the tester for syncing from peers
	peerDb  gooladb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	testdb, _ := gooladb.NewMemDatabase()
	...
	tester.stateDb, _ = gooladb.NewMemDatabase()
