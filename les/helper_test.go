...
func newTestProtocolManager(lightSync bool, blocks int, generator func(int, *core.BlockGen), peers *peerSet, odr *LesOdr, db gooladb.Database) (*ProtocolManager, error) {
	...
	if lightSync {
		...
		bloomIndexer := goolabackend.NewBloomIndexer(db, params.BloomBitsBlocks)
...
// fails the test.
func newTestProtocolManagerMust(t *testing.T, lightSync bool, blocks int, generator func(int, *core.BlockGen), peers *peerSet, odr *LesOdr, db gooladb.Database) *ProtocolManager {
