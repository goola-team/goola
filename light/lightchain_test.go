...
func makeHeaderChain(parent *types.Header, n int, db gooladb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (gooladb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() gooladb.Database {
	return odr.db
}
