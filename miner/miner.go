...
// Package miner implements Goola block creation and mining.
package miner
...
func New(backend Backend, config *params.ChainConfig, mux *event.TypeMux, engine consensus.Engine) *Miner {
	miner := &Miner{
		backend:  backend,
		mux:      mux,
		engine:   engine,
