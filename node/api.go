...
// PublicGoolajsAPI offers helper utils
type PublicGoolajsAPI struct {
	stack *Node
}

// NewPublicGoolajsAPI creates a new GoolajsService instance
func NewPublicGoolajsAPI(stack *Node) *PublicGoolajsAPI {
	return &PublicGoolajsAPI{stack}
}

// ClientVersion returns the node name
func (s *PublicGoolajsAPI) ClientVersion() string {
	return s.stack.Server().Name
}

// Sha3 applies the Goola sha3 implementation on the input.
// It assumes the input is hex encoded.
func (s *PublicGoolajsAPI) Sha3(input hexutil.Bytes) hexutil.Bytes {
