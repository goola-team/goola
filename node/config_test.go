...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "goola.ipc", false, filepath.Join(os.TempDir(), "goola.ipc")},
		{"data", "goola.ipc", false, "data/goola.ipc"},
		{"data", "./goola.ipc", false, "./goola.ipc"},
		{"data", "/goola.ipc", false, "/goola.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "goola.ipc", true, `\\.\pipe\goola. ipc`},
		{"data", "goola.ipc", true, `\\.\pipe\goola. ipc`},
		{"data", `\\.\pipe\goola. ipc`, true, `\\.\pipe\goola. ipc`},
	}
