...
/*
Package node sets up multi-protocol Goola nodes.
...
endpoint to a subset of RPC modules. Node itself offers the "debug", "admin" and "goolajs"
modules.
...
Node also creates the shared store of encrypted Goola account keys. Services can access
