...
import (
	...
	"github.com/goola-team/goola/contracts/chequebook"
	...
	"github.com/goola-team/goola/swarm/api"
	httpapi "github.com/goola-team/goola/swarm/api/http"
	"github.com/goola-team/goola/swarm/fuse"
	"github.com/goola-team/goola/swarm/network"
	"github.com/goola-team/goola/swarm/storage"
)
...
func NewSwarm(ctx *node.ServiceContext, backend chequebook.Backend, ensClient *goolaclient.Client, config *api.Config, swapEnabled, syncEnabled bool, cors string) (self *Swarm, err error) {
	...
	log.Debug(fmt.Sprintf("-> Goolajs virtual server API"))
