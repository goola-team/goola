...
type Database struct {
	diskdb gooladb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb gooladb.Database) *Database {
	return &Database{
		diskdb: diskdb,
...
func (db *Database) commit(hash common.Hash, batch gooladb.Batch) error {
	// If the node does not exist, it's a previously committed node
